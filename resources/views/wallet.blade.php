<x-user-layout activePage="wallet" page="Wallet">
        ...
        <div class="flex bg-white w-full lg:w-[80%] lg:h-[290px] h-fit shadow-lg rounded-xl px-8 pb-8">
            <div class="w-full flex flex-col leading-tight">
                ...
                <div class="w-full gap-10 lg:gap-6 flex lg:flex-row flex-col justify-center">
                    ...
                    <div id="addfunds"
                        class="bg-[#44BCFF0D] w-full h-[138px] shadow-lg mt-7 rounded-xl flex flex-col justify-center items-center cursor-pointer">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <mask id="mask0_58_4366" style="mask-type: luminance" maskUnits="userSpaceOnUse" x="2" y="4"
                                width="20" height="16" class="items-centercenter">
                                <path
                        ...
                        <h1 class="text-center dm-sans-medium text-[14px text-[#222222]">
                            Add Funds
                        </h1>
                    </div>
                </div>
    ...
    <div class="flex flex-col bg-white w-full lg:w-[80%] min-h-[600px] mb-4 mt-8 rounded-xl overflow-x-scroll">
        <div class="flex flex-col md:flex-row">
            ...
            <form action="/user/wallet" method="GET" class="flex flex-col md:flex-row">
                <div class="flex relative ml-5 lg:ml-0 mt-[40px]">
        ...
        <table class="min-w-full mt-8">
            ...
            <tbody>
                @foreach ($wallets as $wallet)
                    <tr class="border-b border-gray-300 text-[#222222] dm-sans-medium text-[14px]">
                        <td class="px-8 py-5 pl-6 whitespace-nowrap">{{ $wallet->id }}</td>
                        <td class="px-8 py-5 whitespace-nowrap">
