...
<body class="bg-gray-100 font-family-karla flex">
    <!-- side bar -->
    <aside class="relative bg-[#ffffff] h-[663.25px] w-64 hidden sm:block">
        <div class="p-6">
            <img src="/img/image_4.jpg" alt="logo" class="w-[130px] h-[40.73px]" />
        </div>
        <nav class="text-white text-xs font-semibold pt-3">
            <a href="dashboard.html" class="flex items-center py-2 px-8 text-gray-600 mt-7">
                <svg width="25" height="25" viewBox="0 0 25 25" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <mask id="mask0_58_3907" style="mask-type: luminance" maskUnits="userSpaceOnUse" x="0" y="0"
                        width="25" height="25">
                        <rect x="0.5" y="0.25" width="24" height="24" fill="white" />
                    </mask>
                    <g mask="url(#mask0_58_3907)">
                        <path
                ...
                <span class="pl-5 dm-sans-medium text-[13.5px] text-[#222222B2]">Dashboard</span>
            </a>

            <a href="order.html" class="flex items-center py-2 px-8 text-gray-600 mt-7">
                <svg width="25" height="25" viewBox="0 0 25 25" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                ...
                <span class="pl-5 dm-sans-medium text-[13.5px] text-[#222222B2]n">Orders</span>
            </a>

            <a href="wallet.html"
                class="flex items-center py-[12px] px-5 bg-[#DF5C0C] text-white rounded-xl ml-8 mt-7 mr-4 shadow-md">
                <svg width="25" height="25" viewBox="0 0 25 25" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <path
                ...
                <span class="pl-5 dm-sans-medium text-[13.5px] text-[#ffffff]">Wallet</span>
            </a>

            <a href="Account..html" class="flex items-center py-2 px-8 text-gray-600 mt-7">
                <svg width="25" height="25" viewBox="0 0 25 25" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <path
                ...
                <span class="pl-5 dm-sans-medium text-[13.5px] text-[#222222B2]">Account</span>
            </a>

            <a href="/signout" class="flex items-center py-2 px-8 text-gray-600 mt-7">
    ...
    <div class="w-full flex flex-col h-screen overflow-y-hidden">
        <!-- Desktop Header -->
        <header class="w-full items-center bg-white py-2 px-6 hidden sm:flex justify-between">
            <div class="flex flex-row justify-between">
                <p class="text-[#222222] plus-jakarta-sans-medium text-[30px] ml-4">
                    Account
                </p>
                <div class="flex ml-[1000px]">
                    <img src="/img/Rectangle 1393.jpg" alt="User" class="w-[45px] h-[45px]" />
                    <div class="ml-2">
                        <p class="text-[12px] text-[#222222] font-semibold">Oladimeji</p>
        ...
        <!-- Mobile Header & Nav -->
        <header x-data="{ isOpen: false }" class="w-full bg-[#ffffff] py-5 px-6 sm:hidden">
            ...
            <nav :class="isOpen ? 'flex' : 'hidden'" class="flex flex-col pt-4">
                <a href="/admin/users/edit/me" class="flex items-center text-[#222222] py-2 pl-4 nav-item">
                    <svg width="25" height="25" viewBox="0 0 25 25" fill="none"
                ...
                <a href="/admin/orders" class="flex items-center text-[#222222] py-2 pl-4 nav-item">
                    <svg width="25" height="25" viewBox="0 0 25 25" fill="none"
                        xmlns="http://www.w3.org/2000/svg" class="mr-3">
                        <path fill-rule="evenodd" clip-rule="evenodd"
                            d="M8.91803 3.5C9.19803 2.91 9.80203 2.5 10.5 2.5H14.5C15.198 2.5 15.801 2.91 16.082 3.5C16.765 3.506 17.298 3.537 17.774 3.723C18.3423 3.94527 18.8364 4.32301 19.2 4.813C19.567 5.307 19.74 5.94 19.976 6.811L20.718 9.533L20.998 10.374L21.022 10.404C21.923 11.558 21.494 13.274 20.636 16.705C20.09 18.888 19.818 19.979 19.004 20.615C18.19 21.25 17.065 21.25 14.815 21.25H10.185C7.93503 21.25 6.81003 21.25 5.99603 20.615C5.18203 19.979 4.90903 18.888 4.36403 16.705C3.50603 13.274 3.07703 11.558 3.97803 10.404L4.00203 10.374L4.28203 9.533L5.02403 6.811C5.26103 5.94 5.43403 5.306 5.80003 4.812C6.16376 4.32238 6.65793 3.945 7.22603 3.723C7.70203 3.537 8.23403 3.505 8.91803 3.5ZM8.92003 5.003C8.25803 5.01 7.99203 5.035 7.77203 5.121C7.466 5.24068 7.19984 5.44411 7.00403 5.708C6.82803 5.945 6.72403 6.276 6.43403 7.343L5.86403 9.432C6.88403 9.25 8.27803 9.25 10.184 9.25H14.815C16.722 9.25 18.115 9.25 19.135 9.43L18.566 7.341C18.276 6.274 18.172 5.943 17.996 5.706C17.8002 5.44211 17.5341 5.23868 17.228 5.119C17.008 5.033 16.742 5.008 16.08 5.001C15.938 5.29985 15.7142 5.55232 15.4346 5.72914C15.1549 5.90596 14.8309 5.99987 14.5 6H10.5C10.1693 5.99996 9.8453 5.9062 9.56566 5.72956C9.28602 5.55293 9.06216 5.30166 8.92003 5.003Z"
                ...
                <a href="/admin/users/edit/me"
                    class="flex items-center bg-[#df5c0c] text-[#ffffff] py-2 pl-4 nav-item rounded-lg mr-64">
                    <svg width="25" height="25" viewBox="0 0 25 25" fill="none"
                        xmlns="http://www.w3.org/2000/svg" class="mr-3">
                        <path
                            d="M6.5 20.25C5.4 20.25 4.45833 19.8583 3.675 19.075C2.89167 18.2917 2.5 17.35 2.5 16.25V8.25C2.5 7.15 2.89167 6.20833 3.675 5.425C4.45833 4.64167 5.4 4.25 6.5 4.25H18.5C19.6 4.25 20.5417 4.64167 21.325 5.425C22.1083 6.20833 22.5 7.15 22.5 8.25V16.25C22.5 17.35 22.1083 18.2917 21.325 19.075C20.5417 19.8583 19.6 20.25 18.5 20.25H6.5ZM6.5 8.25H18.5C18.8667 8.25 19.2167 8.29167 19.55 8.375C19.8833 8.45833 20.2 8.59167 20.5 8.775V8.25C20.5 7.7 20.3043 7.22933 19.913 6.838C19.5217 6.44667 19.0507 6.25067 18.5 6.25H6.5C5.95 6.25 5.47933 6.446 5.088 6.838C4.69667 7.23 4.50067 7.70067 4.5 8.25V8.775C4.8 8.59167 5.11667 8.45833 5.45 8.375C5.78333 8.29167 6.13333 8.25 6.5 8.25ZM4.65 11.5L15.775 14.2C15.925 14.2333 16.075 14.2333 16.225 14.2C16.375 14.1667 16.5167 14.1 16.65 14L20.125 11.1C19.9417 10.85 19.7083 10.646 19.425 10.488C19.1417 10.33 18.8333 10.2507 18.5 10.25H6.5C6.06667 10.25 5.68767 10.3627 5.363 10.588C5.03833 10.8133 4.80067 11.1173 4.65 11.5Z"
                ...
                <a href="/admin/users/edit/me" class="flex items-center py-2 pl-4 nav-item rounded-lg mr-64">
                    <svg width="25" height="25" viewBox="0 0 25 25" fill="none"
                        xmlns="http://www.w3.org/2000/svg" class="mr-3">
                        <path
                            d="M12.5 2.25C6.98 2.25 2.5 6.73 2.5 12.25C2.5 17.77 6.98 22.25 12.5 22.25C18.02 22.25 22.5 17.77 22.5 12.25C22.5 6.73 18.02 2.25 12.5 2.25ZM12.5 6.25C14.43 6.25 16 7.82 16 9.75C16 11.68 14.43 13.25 12.5 13.25C10.57 13.25 9 11.68 9 9.75C9 7.82 10.57 6.25 12.5 6.25ZM12.5 20.25C10.47 20.25 8.07 19.43 6.36 17.37C8.1116 15.9957 10.2736 15.2488 12.5 15.2488C14.7264 15.2488 16.8884 15.9957 18.64 17.37C16.93 19.43 14.53 20.25 12.5 20.25Z"
        ...
        <div class="flex flex-col overflow-y-scroll">
            <div class="flex lg:flex-row flex-col">
                <div
                    class="flex bg-white lg:w-[725px] lg:h-[290px] h-[600px] w-[400px] shadow-lg lg:ml-8 ml-7 mt-7 rounded-xl">
                    <div class="flex flex-col leading-tight">
                        <h1
                            class="dm-sans-medium text-[#222222] lg:text-2xl text-[28px] font-semibold mt-4 lg:ml-6 ml-10">
                            Overview
                        </h1>
                        <p class="ml-10 lg:ml-6 dm-sans-medium lg:text-[12px] text-[14px] text-[#22222299]">
                            Your Account Summary
                        </p>

                        <div class="flex lg:flex-row flex-col justify-center">
                            <div
                                class="bg-[#FFE2E5] lg:w-[200px] w-[310px] h-[138px] shadow-lg lg:ml-6 ml-10 mt-7 rounded-xl">
                            ...
                            <div class="bg-[#DCFCE7] lg:w-[200px] w-[310px] h-[138px] shadow-lg ml-9 mt-7 rounded-xl">
                            ...
                            <div
                                ...
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    ...
                                    <g mask="url(#mask0_58_4366)">
                                        <path d="M0 0H24V24H0V0Z" fill="#222222" />
                                    </g>
                                </svg>
                                <a href="#">
                                    <h1 id="addfunds" class="text-center dm-sans-medium text-[14px text-[#222222]">
                                        Add Funds
                                    </h1>
                                </a>
                            </div>
                ...
                <div
                    class="flex flex-col bg-[#DF5C0C] lg:w-[337px] lg:h-[292.24px] w-[337px] shadow-xl ml-14 mt-7 rounded-xl justify-center items-center mb-4">
                    <svg width="43" height="41" viewBox="0 0 43 41" fill="none"
                        xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                        class="items-center mt-6 w-[43px] h-[41px]">
            ...
            <div class="flex flex-col bg-white w-[725px] min-h-[600px] mb-4 lg:ml-8 ml-7 mt-8 rounded-xl">
                <div class="flex flex-row">
                    <h1
                        class="dm-sans-medium text-[22px] text-[#000000] mt-[43px] text-2xl ml-6 font-semibold w-[70%]">
                        History
                    </h1>

                    <div class="flex flex-row">
                        <button class="flex pl-52 mt-[40px]">
                            <input type="text" placeholder="Search"
                                class="bg-[#F9FBFF] text-[#22222280] dm-sans-regular text-[12px] rounded-lg w-[216px] h-[38px] pl-11 relative" />
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg" class="fixed m-2 W-[24px] h-[24px]">
                                <path
                                    d="M11 19C15.4183 19 19 15.4183 19 11C19 6.58172 15.4183 3 11 3C6.58172 3 3 6.58172 3 11C3 15.4183 6.58172 19 11 19Z"
                                    stroke="#7E7E7E" stroke-width="2" stroke-linecap="round"
                                    stroke-linejoin="round" />
                                <path d="M20.9999 21L16.6499 16.65" stroke="#7E7E7E" stroke-width="2"
                ...
                <table class="min-w-full mt-8">
                    ...
                    <tbody>
                        <tr class="border-b border-gray-300 text-[#222222] dm-sans-medium text-[14px]">
                            <td class="px-8 py-5 pl-6 whitespace-nowrap">115453</td>
                            <td class="px-8 py-5 whitespace-nowrap">Account Funding</td>
                            <td class="px-8 py-5 whitespace-nowrap">26-04-2024</td>
                            <td class="px-8 py-5 whitespace-nowrap" class="text-[#00B087]">
                                +N500
                            </td>
                        </tr>
                        ...
                        <tr class="border-b border-gray-300 text-[#222222] dm-sans-medium text-[14px]">
                            <td class="px-8 py-5 pl-6 whitespace-nowrap">115453</td>
                            <td class="px-8 py-5 whitespace-nowrap">Purchased Number</td>
                            <td class="px-8 py-5 whitespace-nowrap">26-04-2024</td>
                            <td class="px-8 py-5 whitespace-nowrap" class="text-[#DF5C0C]">
                                -N500
                            </td>
                        </tr>
                        ...
                        <tr class="border-b border-gray-300 text-[#222222] dm-sans-medium text-[14px]">
                            <td class="px-8 py-5 pl-6 whitespace-nowrap">115453</td>
                            <td class="px-8 py-5 whitespace-nowrap">Purchased Number</td>
                            <td class="px-8 py-5">26-04-2024</td>
                            <td class="px-8 py-5" class="text-[14px] text-[#DF5C0C]">
                                -N500
                            </td>
                        </tr>
                    </tbody>
    ...
    <!-- <div> -->
    <div id="numberModal"
        class="fixed flex bg-[#ffffff] h-[50%] lg:h-[52%] lg:w-[50%] w-[90%] rounded-3xl lg:ml-80 ml-5 flex-col mt-10 lg:mt-20 mb-3 hidden">
        <div class="flex flex-row justify-between mt-5 lg:mt-6">
            <div class="items-start flex-row flex ml-6">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                    xmlns="http://www.w3.org/2000/svg" class="mt-1 mr-2">
                    <path d="M5 12H12M12 12H19M12 12V5M12 12V19" stroke="#222222" stroke-width="2"
                        stroke-linecap="round" stroke-linejoin="round" />
                </svg>
                <h1 class="items-start text-[#222222] dm-sans font-extrabold text-[20px] lg:text-[24px]">Add Funds</h1>
            </div>
        ...
        <div class="flex flex-row bg-[#DF5C0C1A] rounded-xl lg:w-[94%] w-[90%] h- ml-6 lg:mt-6 mt-5">
            ...
            <div class="mt-3 ml-4 lg:ml-6 lg:mr-4 mr-2 mb-3 leading-tight">
                <p class="dm-sans-regular text-[15px] lg:text-[14px]">Fund your account to be able to purchase mobile
                    numbers.
        ...
        <div class="flex flex-col ml-6 mr-5 mt-5 lg:ml-6 rounded-md">
            <div class="flex flex-col">
                ...
                <input type="text" class=" rounded-md border border-[#D9D9D9D9] bg-[#FCFCFD] p-2">
            </div>
        </div>
