<!-- modal content -->
<div id="numberModal2" class="flex fixed w-full h-full bg-black/25 items-center justify-center hidden">
    <div class="flex bg-[#ffffff] h-[full] lg:w-[50%] w-[90%] rounded-3xl flex-col mt-10 mb-3">
        ...
        <div class="flex flex-row ml-6 mr-5 mt-5 lg:ml-6 justify-between bg-[#DF5C0C0D] rounded-md lg:bg-transparent">
            <div class="lg:bg-[#DF5C0C0D] rounded-md lg:mr-5 flex flex-row lg:h-[36px] lg:w-[265px] items-center">
                ...
                <p><span class="font-bold">Service:</span> Discord</p>
            </div>
            ...
            <div class="lg:bg-[#DF5C0C0D] flex flex-row lg:mr-5 rounded-md lg:h-[36px] lg:w-[265px] items-center">
                ...
                <p> <span class="font-bold">Number:</span> 18156166321</p>
            </div>
        ...
        <div
            ...
            <div class="flex-col">
                ...
                <div class="lg:mt-4 lg:ml-3 lg:mb-4 mr-3 ml-3 mb-3 mt-2">
                    <p>Your Discord verification code is: 123456. Enter this code on the Discord app to complete
                        your account verification.
                        Please note that this code will expire in 10 minutes. If you didn't request this code,
...
<div id="Order" class="flex fixed w-full h-full bg-black/25 items-center justify-center hidden">
    <div class="flex bg-[#ffffff] h-[full] lg:w-[50%] w-[90%] rounded-3xl flex-col mt-10 mb-3">
        ...
        <div class="flex flex-row ml-6 mr-5 mt-5 lg:ml-6 rounded-md mb-6">
            <div class="bg-[#DF5C0C0D] rounded-md lg:mr-5 flex flex-row lg:h-[36px] w-[60%] lg:w-[265px] items-center">
            ...
            <div class="bg-[#DF5C0C0D] flex flex-row ml-5 lg:mr-5 rounded-md lg:h-[36px] w-[35%] items-center">
                ...
                <p> <span class="font-bold">Price:</span> N575</p>
            </div>
        </div>

        <div class="flex justify-end items-end mb-4">
            <button id="Ordernow"
                class="lg:mt-5 mt-3 lg:w-[180px] lg:h-[49px] bg-[#DF5C0C] text-white lg:py-2 p-2 rounded-lg dm-sans-extrabold text[12px] mr-6">
                Order Now
            </button>
        </div>
    </div>
